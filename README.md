...
> In the table above, **TRUST™ is the only fully interpretable model above 0.6 R²** across varied benchmark datasets — and **6× sparser** than M5' (*17 vs 109 coefficients* on average).  
