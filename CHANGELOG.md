...
- Changed:
  1. sklearn >= 1.8.0 introducing the `use_legacy_attributes` parameter (v3.1.1 fix).
...
- Changed:
  ...
  4. Renamed the TRUST class as TRUSTRegressor (anticipating the future addition of TRUSTClassifier). The TRUST class will still be around until version 4.0.0 to help transition.
  5. Minor bug fixes
- Removed:
