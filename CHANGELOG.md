...
- Changed:
  ...
  4. Renamed the TRUST class as TRUSTRegressor (TRUSTClassifier is coming soon...). The TRUST class will still be around until version 5.0.0 to help transition.
  5. Minor bug fixes
- Removed:
